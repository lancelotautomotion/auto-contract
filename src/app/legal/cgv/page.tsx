    ...
    <>
      ...
      <div className="legal-layout">
        ...
        <div className="legal-content">
          ...
          <p>Prysme étant un service dédié aux <strong>professionnels</strong> (propriétaires et gérants d&apos;hébergement dans le cadre de leur activité), le droit de rétractation prévu par le Code de la consommation ne s&apos;applique pas.</p>
          <p>Dans un esprit de satisfaction client, Prysme étudie néanmoins toute demande de remboursement formulée dans les <strong>7 jours</strong> suivant la première souscription, à adresser à <a href="mailto:contact@prysme.app">contact@prysme.app</a>. Ces gestes commerciaux relèvent de la seule appréciation de Prysme et ne constituent pas un droit au remboursement.</p>
          ...
          <p><strong>Obligations du Client :</strong> utiliser le service conformément à la loi et aux <a href="/legal/cgu">CGU</a>, ne pas partager ses identifiants, vérifier la conformité légale, fiscale et réglementaire des contrats qu&apos;il émet, répondre de ses relations avec ses locataires. Prysme est un outil de génération documentaire et ne fournit <strong>aucun conseil juridique</strong>.</p>
          <p><strong>Obligations de Prysme :</strong> mettre en œuvre les moyens raisonnables pour maintenir le service disponible et assurer la sécurité des données, répondre aux demandes de support sous 48 heures ouvrées. Prysme n&apos;est tenu qu&apos;à une <strong>obligation de moyens</strong>.</p>
          <p><strong>Plafond de responsabilité.</strong> Dans les limites autorisées par la loi, la responsabilité de Prysme envers le Client, toutes causes confondues et tous préjudices cumulés, est strictement plafonnée aux <strong>sommes effectivement encaissées auprès du Client au cours des trois (3) derniers mois</strong> précédant le fait générateur. Sont expressément exclus les dommages indirects, pertes d&apos;exploitation, pertes de chiffre d&apos;affaires, de clientèle, de chance, de données, manque à gagner, atteinte à l&apos;image, ainsi que les préjudices subis par des tiers, notamment les locataires du Client.</p>
          <p><strong>Garantie du Client.</strong> Le Client garantit Prysme contre tout recours, réclamation, action ou condamnation qui pourrait être introduit à son encontre par un tiers — et notamment par un locataire — en lien avec l&apos;utilisation du service, avec un contrat généré, avec une réservation traitée ou avec une information saisie par le Client. Le Client s&apos;engage à prendre en charge l&apos;intégralité des sommes, frais de procédure, honoraires d&apos;avocat et condamnations qui en résulteraient.</p>
          <p>Les présentes limitations ne s&apos;appliquent pas en cas de faute lourde ou dolosive dûment établie de Prysme, ni dans les cas où la loi l&apos;interdit.</p>
