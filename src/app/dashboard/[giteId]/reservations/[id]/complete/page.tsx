      ...
      <div className="content" style={{ maxWidth: '820px' }}>
        ...
        <div className="req-header">
          <div className="rh-left">
            <div className="rh-tag"><svg width="12" height="12" fill="none" viewBox="0 0 12 12"><circle cx="6" cy="6" r="3" stroke="currentColor" strokeWidth="1.2"/><path d="M6 4v2l1.5 1" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/></svg> Nouvelle demande client</div>
        ...
        <div className="req-info-card">
          <div className="cc-header"><span className="req-info-title"><svg width="14" height="14" fill="none" viewBox="0 0 14 14"><circle cx="7" cy="5" r="3" stroke="currentColor" strokeWidth="1.2"/><path d="M2 13c0-2.8 2.2-5 5-5s5 2.2 5 5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/></svg> Informations transmises par le client</span></div>
          <div className="req-info-body">
            ...
            {reservation.reservationOptions.length > 0 && (
              <div style={{ marginBottom: '20px' }}>
                ...
                <div className="req-opt-pills">{reservation.reservationOptions.map(o => <span key={o.id} className="req-opt-pill"><svg width="12" height="12" fill="none" viewBox="0 0 12 12"><path d="M3 6l2 2 4-4" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/></svg>{o.label}{o.price > 0 ? ` — ${o.price} €` : ''}</span>)}</div>
              </div>
            )}
