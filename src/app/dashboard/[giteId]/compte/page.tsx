...
import CompteClient from "@/app/dashboard/compte/CompteClient";
  ...
  return (
    <>
      <div className="topbar">
        <div className="topbar-left"><div className="topbar-breadcrumb">Kordia / <span>Mon compte</span></div></div>
