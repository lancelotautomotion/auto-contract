      ...
      <nav className="nav">
        <div className="nav-inner">
          <Link className="nav-logo" href="/">
            <Image src="/logotype_KORDIA.svg" alt="Kordia" width={400} height={85} priority style={{ height: 28, width: 'auto' }} />
          </Link>
      ...
      >
        <div className="nav-drawer-head">
          <Link className="nav-logo" href="/" onClick={close}>
            <Image src="/logotype_KORDIA.svg" alt="Kordia" width={400} height={85} style={{ height: 24, width: 'auto' }} />
          </Link>
          <button
            type="button"
